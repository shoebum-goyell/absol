...
import 'package:absol/NewTask.dart';
import 'dart:async';
import 'package:absol/markertype.dart';
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          _buildContainer(),
          printCards(lats, longs, cons, resources, conditions,distances),
                ...
                if (snapshot.hasData) {
                  return ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        if(lats.contains(mypost['latitude']) && conditions.contains(mypost['condition']))
                          {
                            return Container();
                          }
                        else{
                          ...
                          conditions.add( mypost['condition']);
                          resources.add( mypost['resource']);
  ...
  Widget myDetailsContainer1(String board, String grade, String material) {
    ...
    return Column(
      ...
      children: <Widget>[
        ...
        Container(
            child: Text(
              "Explaination:" + material.substring(0,j),
              style: TextStyle(
                  color: Colors.black,
                  fontSize: 18.0,
                  fontWeight: FontWeight.bold
